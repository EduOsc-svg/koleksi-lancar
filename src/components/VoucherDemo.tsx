      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <p className="mt-2 text-gray-600">
            Preview voucher di layar dan print dengan layout A4 landscape (3x3 grid)
          </p>
        </div>
      </div>
        ...
        <div className="flex gap-4 mb-6">
          {!showPreview ? (
            ...
            <div className="flex gap-4">
              ...
              >
                🖨️ Print Vouchers (9 per halaman)
              </button>
              <button 
          ...
          <div className="voucher-preview-container mb-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-800">📋 Voucher Preview (3x3 Grid)</h3>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>✅ <strong>Gap 10mm</strong>: Spasi yang cukup antar voucher</li>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <ol className="space-y-2 text-sm text-gray-600">
              ...
              <li>6. Voucher akan muncul dalam grid 3x3 (9 voucher)</li>
            </ol>
          </div>
        </div>
      </div>
