      ...
      <Dialog open={detailDialogOpen} onOpenChange={setDetailDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh]">
          ...
          <div className="relative max-h-[60vh] overflow-hidden">
            ...
            <div 
              className="h-full overflow-y-auto px-1 space-y-6 scrollbar-thin scrollbar-thumb-muted-foreground/20 scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/40 transition-colors"
              onScroll={(e) => {
          ...
          <DialogFooter className="sticky bottom-0 z-10 bg-background pt-4 border-t">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-background to-transparent z-10 opacity-100 transition-opacity duration-200 pointer-events-none" id="scroll-bottom-indicator" />
          </div>
          
          <DialogFooter className="sticky bottom-0 z-10 bg-background pt-4">
            <Button variant="outline" onClick={() => setDetailDialogOpen(false)}>Tutup</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
